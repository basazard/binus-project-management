                ...
                <div class="bg-white overflow-hidden mt-8 px-2">
                    <div class="bg-white">
                        ...
                        <form action="{{ route('tasks.store') }}" method="POST">
                            ...
                            <!-- Project ID (Hidden) -->
                            <div class="mb-4">
                                <label for="project_id" class="block text-gray-700 font-semibold text-sm mb-2">Project</label>
                                <select name="project_id" id="project_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="5" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400"></textarea>
                            </div>
                            ...
                            <!-- Submit Button -->
                            <div class="mb-4">
                                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold text-sm py-2 px-4 rounded">Create Task</button>
                            </div>
                        </form>
                    </div>
                </div>
